#!/usr/bin/env python3
"""
Generate a new contractor contact dashboard with dual contact person columns
"""
...
def generate_dashboard():
    """Generate the complete HTML dashboard with dual contacts"""
    
    # Load the updated data
    df = pd.read_csv('plumber_contacts_dual_contacts.csv')
...
<head>
    ...
    <title>Plumbing Contractor Contact Dashboard - Dual Contacts</title>
    <style>
        body {{
...
<body>
    <div class="container">
        ...
        <h1>Plumbing Contractor Contact Dashboard - Enhanced with Dual Contact Information</h1>
        
        <div class="contact-comparison">
            <h3>Contact Person Information Explained</h3>
            <ul>
                <li><strong>Permit Contact Person:</strong> The individual who submitted building permits on behalf of the company (from City of Minneapolis permit data)</li>
                <li><strong>License Contact Person:</strong> Currently marked as "Not Available" - The Minnesota plumbing license database only contains company contact information (phone/email) but not individual contact names</li>
            </ul>
        </div>
        ...
        <table id="contractorTable">
            <thead>
                <tr>
                    ...
                    <th onclick="sortTable('permitContact')">Permit Contact ↕</th>
    ...
    <script>
        ...
        function applyFilters() {{
            ...
            if (searchTerm) {{
                filtered = filtered.filter(c => 
                    ...
                    c.permitContact.toLowerCase().includes(searchTerm) ||
        ...
        function downloadCSV() {{
            const headers = ['Company Name', 'Permit Contact Person', 'License Contact Person', 'Phone', 'Email', 'Total Permits', 'Last Permit', 'Activity Level', 'Days Since Last', 'Source', 'Confidence'];
            ...
            a.href = url;
            a.download = 'plumber_contacts_dual_' + new Date().toISOString().split('T')[0] + '.csv';
            a.click();
        ...
        function downloadCallList() {{
            ...
            const headers = ['Company Name', 'Permit Contact', 'Phone', 'Email', 'Total Permits', 'Last Activity', 'Confidence'];
    ...
    print(f"Generated new dashboard: {output_file}")
